    ...
    Column(Modifier.fillMaxWidth()) {
        Row(Modifier.weight(1f)) {
            Quadrant(
                ...
                description = stringResource(id = R.string.q1_description),
                backgroundColor = Color(0xFFEADDFF),
                modifier = Modifier.weight(1f)
            )
            Quadrant(
                title = stringResource(id = R.string.q2_title),
                description = stringResource(id = R.string.q2_description),
        ...
        Row(Modifier.weight(1f)) {
            Quadrant(
                ...
                description = stringResource(id = R.string.q3_description),
                backgroundColor = Color(0xFFB69DF8),
                modifier = Modifier.weight(1f)
            )
            Quadrant(
                title = stringResource(id = R.string.q4_title),
                description = stringResource(id = R.string.q4_description),
